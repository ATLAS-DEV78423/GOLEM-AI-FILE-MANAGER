...
ICON_LIBRARY: tuple[IconDef, ...] = (
    ...
    IconDef("check", "M9.55 17.6 4 12.05l1.4-1.4 4.15 4.15L18.6 5.75 20 7.15z"),
    IconDef(
        "x",
        "M6.4 4.99 12 10.59l5.6-5.6 1.4 1.4-5.6 5.6 5.6 5.6-1.4 1.4-5.6-5.6-5.6 5.6-1.4-1.4 5.6-5.6-5.6-5.6z",
    ),
    IconDef(
        "alert", "M12 2 1 21h22L12 2zm0 4.5L19.53 19H4.47L12 6.5zM11 10v5h2v-5h-2zm0 6v2h2v-2h-2z"
    ),
    IconDef(
        "gear",
    ...
    IconDef("chevron-down", "M7.41 8.59 12 13.17l4.59-4.58L18 10l-6 6-6-6z"),
    IconDef("chevron-up", "M7.41 15.41 12 10.83l4.59 4.58L18 14l-6-6-6 6z"),
    IconDef("chevron-right", "M9 6l6 6-6 6-1.41-1.41L12.17 12 7.59 7.41z"),
    IconDef(
        "eye",
    ...
    IconDef("plus", "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6z"),
    IconDef(
        "trash",
    ...
    IconDef("play", "M8 5v14l11-7z"),
    IconDef("pause", "M6 5h4v14H6V5zm8 0h4v14h-4V5z"),
    IconDef(
        "logo",
    ...
    IconDef("arrow-right", "M5 12h12.17l-3.58-3.59L15 7l6 6-6 6-1.41-1.41L17.17 14H5z"),
    IconDef("info", "M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"),
    IconDef("warning", "M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"),
    IconDef(
        "document",
